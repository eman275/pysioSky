export default {
  ...
  quotation_expiry_warning: {
    minutes_left: 'متبقي 5 دقائق!',
    warning_msg: 'يرجى ملاحظة أن هذه العروض ستنتهي خلال 5 دقائق',
    ok: 'موافق',
  },
  quotation_expired_warning: {
    time_out: 'انتهى الوقت!',
    warning_msg:
      'عذرًا، انتهت صلاحية هذه العروض. يرجى العودة إلى الصفحة الرئيسية وطلب عرض جديد إذا لزم الأمر.',
    return_to_vehicle_list: 'العودة إلى قائمة المركبات',
